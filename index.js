...
const showBanner = () => {
  ...
  const author =
    chalk.yellow("\nSource: ") +
    chalk.underline.greenBright("https://t.me/jackjavi254\n");
...
To trigger the hidetag, send a message to a group with any text content.\n`
    );
...
Untuk mentrigger hidetag, kirim pesan ke sebuah grup dengan teks apapun.\n`
    );
